            ...
            <div className="grid gap-6 p-6 lg:grid-cols-[minmax(0,1fr)_420px]">
              <div>
                ...
                <h2 className="mt-3 text-[19px]">
                  Add the first trade partner on an upcoming job.
                </h2>
              ...
              <div className="grid gap-2">
                {[
                  ...
                  <div
                    key={step}
                    className="flex gap-3 rounded-xl border border-border bg-surface-muted p-3.5"
                  >
                    <span className="grid h-7 w-7 shrink-0 place-items-center rounded-lg bg-ink text-[10px] font-bold text-white">
                      {step}
                    </span>
                    <div>
                      <p className="text-[11px] font-bold text-ink">{title}</p>
                      <p className="mt-0.5 text-[9px] text-muted-foreground">{copy}</p>
                    </div>
                  </div>
                ))}
              </div>
